...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    "stability": "experimental",
    "scope": "write",
    "summary": "Ask one of the world's own spawners near the player to fire — a predator (hostile by design) or a rare pal. Unlike pal.spawn this does not construct an NPC by hand: the game spawns it through its normal path, so it gets the AI a wild pal has. Reports which spawner and call shape worked.",
    "params": {
      "kind": {
        "type": "string",
        "default": "predator",
