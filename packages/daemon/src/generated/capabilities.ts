...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    "stability": "experimental",
    "scope": "write",
    "summary": "Make a player unkillable, or mortal again. Sets Unreal's own bCanBeDamaged on the character, which is what TakeDamage consults — this build's IsImmortality and enemy damage-rate flags were both verified written and both left the player mortal. Read back, so a build that ignores the write says so.",
    "params": {
      "on": {
        "type": "bool",
        "default": true
